            ...
            <div class="col-md-6">
                <div class="card bg-c-blue order-card">
                    <div class="card-body">
                        ...
                        <p class="m-b-0 text-right">Shortcode: {{ auth()->user()->shortcode }} <span
                                class="float-left">Account :
                                {{ auth()->user()->account }}</span></p>
                    </div>
                </div>
            </div>
            <div class="card">
                <div class="card-header">
                    <h5>{{ auth()->user()->name }} - <span>This table updates automatically, refreshing
                            resets the table
                            only</span>
                    </h5>
                </div>
